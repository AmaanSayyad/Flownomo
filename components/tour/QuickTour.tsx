...
const TOUR_STEPS: TourStep[] = [
    ...
    },
    {
        ...
        title: 'Quick Deposit',
        content: 'Easily deposit FLOW to start trading. Transactions are instant and secure.',
        position: 'top'
    }
];
...
export const QuickTour: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
    ...
    const steps: TourStep[] = useMemo(() => [
        ...(isConnected ? [] : [{
            ...
            content: 'Start by connecting your wallet. We support Flow Testnet for a seamless trading experience.',
        ...
        },
        {
            ...
            title: 'Manage Your Funds',
            content: isConnected
                ? 'Easily deposit FLOW to start trading. Your house balance is updated instantly.'
