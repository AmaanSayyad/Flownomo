...
const DEMO_EMBED_SRC =
  'https://www.youtube.com/embed/BMNB2nN_NtI?si=oYMim96tAUPahDMH';
    ...
    >
      <div className="relative z-10 mx-auto w-full max-w-[1400px] px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            See <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/35">Flownomo</span> in action
          </h2>
        ...
        >
          ...
          >
            <iframe
              src={DEMO_EMBED_SRC}
              title="Flownomo demo - YouTube video player"
