...
const STEPS = [
    {
        ...
        description: 'Connect your wallet and move assets into the Flownomo hybrid vault. Your liquidity is secured on-chain while enabling millisecond execution speed.',
